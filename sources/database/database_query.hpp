...
namespace data
{
    ...
    public:
        ...
        */
        ...
        std::map<int, std::wstring> getUserNames(const std::vector<int>& aUserIDs) noexcept;
        ...
        UserNames getUsers(const std::vector<std::string>& aMask = {}, bool aSwitchMask = false);
        UserNames getActiveUsers(const std::vector<std::string>& aMask = {}, bool aSwitchMask = false);
        UserNames getDeletedUsers(const std::vector<std::string>& aMask = {}, bool aSwitchMask = false);
    ...
    private:
        ...
        UserNames getUsersByDeleteFlag(bool aIsDeleted, const std::vector<std::string>& aMask = {}, bool aSwitchMask = false);
    };
}
